...
- Native Treesitter for highlighting + folding
...
- `stylua`, `prettier`, `taplo`, `ruff` — installed via Mason
...
- **Lazy-loaded everything** — plugins load on events/keys/commands, not at startup
